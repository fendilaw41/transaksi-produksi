...
@section('content')
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h5 class="content-header-title float-left pr-1 mb-0">Lokasi</h5>
        ...
        <section id="table-success">
            <div class="card mt-2">
                ...
                <div class="table-responsive">
                    <table class="table mb-0" id="t_lokasi">
                        <thead>
                        <tr>
                            <th>No</th>
                            <th>Kode</th>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Tambah Lokasi</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" minlength="2" required placeholder="Nama Lokasi" id="nama_lokasi" name="nama_lokasi" class="form-control">
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <label>Kode: </label>
                        <div class="form-group">
                            <input type="text" minlength="2" required placeholder="Lokasi" id="edit_kode" name="kode" class="form-control">
                        </div>
                        <label>Nama Lokasi: </label>
                        <div class="form-group">
                            <input type="text" minlength="2" required placeholder="Nama Lokasi" id="edit_nama_lokasi" name="nama_lokasi" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
...
@section('scripts')
    ...
    <script src="/src/lokasi.js"></script>
@endsection
