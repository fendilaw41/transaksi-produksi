function getFetchAchivement() {
    $.ajax({
        url: "/achivement/index",
        type: "GET",
        dataType: "JSON",
        beforeSend: function () {
            $("#t_achivement tbody").html(`
            <tr>
...
$(function () {
    ...
    $('#t_achivement').on('click', '.btn_edit', function () {
        let id = $(this).data('id')
        let button = $(this)
        console.log(id);
        $.ajax({
            url: `/achivement/show/${id}`,
            type: 'GET',
            dataType: 'JSON',
            beforeSend: function () {
            ...
            success: function (res) {
                ...
                $('#edit_time_from').val(res.result.time_from)
                $('#edit_time_to').val(res.result.time_to)
    ...
    $('#t_achivement').on('click', '.btn_hapus', function () {
        let id = $(this).data('id')
        console.log(id);
        $.ajax({
            url: `/achivement/show/${id}`,
