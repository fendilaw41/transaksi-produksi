...
$(function () {
    ...
    $('#t_lokasi').on('click', '.btn_edit', function () {
        let id = $(this).data('id')
        let button = $(this)
        console.log(id);
        $.ajax({
            ...
            success: function (res) {
                ...
                $('#edit_nama_lokasi').val(res.result.nama_lokasi)
    ...
    $('#t_lokasi').on('click', '.btn_hapus', function () {
        let id = $(this).data('id')
        console.log(id);
        $.ajax({
            url: `/lokasi/show/${id}`,
